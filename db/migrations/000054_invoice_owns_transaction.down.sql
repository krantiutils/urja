-- Restore the 000053_pan_billing version of the guard (no owns_transaction in
-- the protected tuple), then drop the column it was guarding.
...
ALTER TABLE invoices
    DROP COLUMN IF EXISTS owns_transaction;
