...
//
// Values below are cross-checked against two independently maintained tables
// (github.com/opensource-nepal/node-nepali-datetime and
// github.com/remotemerge/nepali-date-converter), which agree with each other
// on every year from 2000 to 2090 and share this package's epoch.
